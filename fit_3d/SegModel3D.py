...
class BasicBlock(nn.Module):
    def __init__(
        ...
        super().__init__()
        self.conv1 = nn.Conv3d(in_channels, out_channels, 3, 1, padding=padding, padding_mode=padding_mode)
        self.conv2 = nn.Conv3d(out_channels, out_channels, 3, 1, padding=padding, padding_mode=padding_mode)
        ...
        match norm_method:
            ...
            case 'layer':
                self.bn1 = nn.LayerNorm([out_channels, GridSize, GridSize, GridSize, GridSize])
                self.bn2 = nn.LayerNorm([out_channels, GridSize, GridSize, GridSize, GridSize])
            case _:
    ...
    def __init__(
        ...
        match norm_method:
            case 'batch':
                ...
                self.bn2 = nn.BatchNorm3d(out_channels)
            case 'layer':
                self.bn1 = nn.LayerNorm([out_channels, GridSize, GridSize, GridSize])
                self.bn2 = nn.LayerNorm([out_channels, GridSize, GridSize, GridSize])
            case _:
                self.bn1 = nn.Identity()
                self.bn2 = nn.Identity()
        ...
        if in_channels != out_channels:
            self.downsample = nn.Conv3d(in_channels, out_channels, 1, 1, bias=False)
        else:
...
class ResBottleNeck(nn.Module):
    def __init__(
        ...
        self.conv1 = nn.Conv3d(in_channels, mid_channels, 1, 1, padding=padding, padding_mode=padding_mode)
        self.conv2 = nn.Conv3d(mid_channels, mid_channels, 3, 1, padding=padding, padding_mode=padding_mode)
        self.conv3 = nn.Conv3d(mid_channels, out_channels, 1, 1, padding=padding, padding_mode=padding_mode)
        self.act = act
        ...
        match norm_method:
            ...
            case 'layer':
                self.bn1 = nn.LayerNorm([mid_channels, GridSize, GridSize, GridSize])
                self.bn2 = nn.LayerNorm([mid_channels, GridSize, GridSize, GridSize])
                self.bn3 = nn.LayerNorm([out_channels, GridSize, GridSize, GridSize])
            case _:
                self.bn1 = nn.Identity()
                self.bn2 = nn.Identity()
